...
class AtlasI2C:
    ...
    def __init__(self, i2c_bus, address=None, moduletype="", name=""):
        '''
    ...
    def write(self, cmd):
        ...
        '''
        cmd += "\00"
        #self.i2c_bus.write(cmd.encode('latin-1'))
        self.i2c_bus.write(self._address, cmd)
    ...
    def read(self, num_of_bytes=31):
        ...
        response = self.i2c_bus.readfrom(self._address, num_of_bytes)
